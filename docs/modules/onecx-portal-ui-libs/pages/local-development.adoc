...
To do so, follow the documentation on xref:documentation:onecx-docs-start:first-app/running_custom_apps_overview.html[running custom applications locally].
