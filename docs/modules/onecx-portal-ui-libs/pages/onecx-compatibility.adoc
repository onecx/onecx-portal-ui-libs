...
* Please refer to the xref:documentation:docs-guides-ui:angular/cookbook/routing/index.adoc#general-routing-guidelines[OneCX Routing Guide] for using relative paths and other information on routing in OneCX.
...
* For the correct configuration, please refer to the xref:documentation:docs-guides-ui:angular/cookbook/multi-language/multi-language-setup.adoc#provide-translation-path[OneCX Multi-language Translations Guide] and other information on multi-language in OneCX.
