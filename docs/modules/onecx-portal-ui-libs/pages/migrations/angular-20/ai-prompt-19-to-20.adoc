...
You only implement OneCX‑specific post‑migration tasks.
...
Remind them they must complete the Angular 19 → 20 upgrade before you proceed or they can request assistance.
If they tell you to perform the update fetch all required instructions from:
https://angular.dev/update-guide?v=19.0-20.0&l=3
3. Execute Post‑Migration
Once the developer explicitly instructs you:
Complete all post‑migration tasks in order
4. Request Version Information
After completing all post‑migration steps:
Ask the developer for the Angular and OneCX versions they want installed
5. Install Specified Versions
