...
=> *Use createTranslateLoader with provideTranslationPathFromMeta from @onecx/angular-utils*
...
[NOTE]
====
To support multiple locales for missing translations, Please use AngularAcceleratorMissingTranslationHandler from @onecx/angular-accelerator.
====
