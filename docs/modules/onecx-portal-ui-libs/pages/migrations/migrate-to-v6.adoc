...
:theming_url: xref:documentation:docs-guides-ui:angular/cookbook/theming.adoc
...
=>  *Use standalone mode instead xref:documentation:docs-guides-ui:angular/cookbook/migrations/enable-standalone/index.adoc[Documentation]*
