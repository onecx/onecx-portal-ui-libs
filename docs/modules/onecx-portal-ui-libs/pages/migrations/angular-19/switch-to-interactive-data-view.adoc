...
=== Replace p-dataView and DataViewControlsComponent with InteractiveDataViewComponent
...
| columnTemplates
| columnTemplates
| Use `p-template` with appropriate selectors and Angular content projection.
