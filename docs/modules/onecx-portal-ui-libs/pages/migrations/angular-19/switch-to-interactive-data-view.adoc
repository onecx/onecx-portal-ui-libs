...
Replace *DataViewControlsComponent* with *InteractiveDataViewComponent* for enhanced data viewing capabilities including sorting, filtering, and layout options.

**Code changes**

* Remove all usages of `DataViewControlsComponent` from `@onecx/portal-integration-angular`.
* Replace with `InteractiveDataViewComponent` from `@onecx/angular-accelerator`.
...
[NOTE]
====
*InteractiveDataViewComponent* supports advanced data viewing with sorting, filtering, and flexible layouts.  
