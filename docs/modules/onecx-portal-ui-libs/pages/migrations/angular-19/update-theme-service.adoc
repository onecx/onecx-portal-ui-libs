...
In order to load and apply themes overrides with PrimeNG, `provideThemeConfigService()` function can be used. (see (xref:documentation:docs-guides-ui:angular/index.adoc)[Provide Theme Overrides])
