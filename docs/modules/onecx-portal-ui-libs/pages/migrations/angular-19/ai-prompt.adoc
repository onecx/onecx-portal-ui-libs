...
* Check if a PrimeNG MCP server is available
* If available, retrieve PrimeNG migration or upgrade information for the target version
* Record any required PrimeNG migration steps and include them in the migration plan
