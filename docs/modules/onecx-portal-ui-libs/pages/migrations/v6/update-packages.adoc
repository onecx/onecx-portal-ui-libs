...
The following package updates are required as part of the Angular 18 → 19 migration process of the OneCX application to ensure compatibility with Angular 19 and OneCX v6:
