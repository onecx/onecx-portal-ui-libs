...
:integration-interface_url: xref:./integration-interface.adoc
:global_error_topic_url: xref:./integration-interface.adoc#global-error-topic
:global_loading_topic_url: xref:./integration-interface.adoc#global-loading-topic
:current_mfe_topic_url: xref:./integration-interface.adoc#current-mfe-topic
:current_page_topic_url: xref:./integration-interface.adoc#current-page-topic
:current_workspace_topic_url: xref:./integration-interface.adoc#current-workspace-topic
:is_authenticated_topic_url: xref:./integration-interface.adoc#is-authenticated-topic
:configuration_topic_url: xref:./integration-interface.adoc#configuration-topic
:message_topic_url: xref:./integration-interface.adoc#message-topic
:remote_components_topic_url: xref:./integration-interface.adoc#remote-components-topic
:current_theme_topic_url: xref:./integration-interface.adoc#current-theme-topic
:user_profile_topic_url: xref:./integration-interface.adoc#user-profile-topic
:permissions_topic_url: xref:./integration-interface.adoc#permissions-topic
:config_object_url: xref:./integration-interface.adoc#config-object
:theme_object_url: xref:./integration-interface.adoc#theme-object
:route_object_url: xref:./integration-interface.adoc#Route-object
...
|`requestIconAsync(name: string, type?: 'svg' \| 'background' \| 'background-before')` | `Promise<string \| null>` | Resolves with the CSS class when available, or `null` when the icon cannot be found.
|===
+
[TIP]
====
See {icon_service_url}[IconService] for examples, rendering styles, and cache semantics.
====
...
+
It is similar to xref:./angular-integration-interface.adoc#configuration-service[ConfigurationService], however *App Config Service* should be used for a Microfrontend configuration management. If sharing the configuration variable with multiple Microfrontends is desired, please use xref:./angular-integration-interface.adoc#configuration-service[ConfigurationService] and provide variables via Shell Application.
...
+
xref:./angular-integration-interface.adoc#configuration-service[ConfigurationService] *should not be initialized by Microfrontends*. They can utilize specific functionality of this service to access and update configuration data.
...
* HttpClient
* xref:./angular-integration-interface.adoc#configuration-service[ConfigurationService]
...
* HttpClient
* xref:#app-state-service[AppStateService]
