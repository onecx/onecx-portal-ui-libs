...
import type { GuardCheckPromise, GuardMode, GuardsNavigationState } from '../model/guard-navigation.model'
...
export class GuardsNavigationStateController {
   ...
   */
  getMode(guardsNavigationState: GuardsNavigationState): GuardMode {
