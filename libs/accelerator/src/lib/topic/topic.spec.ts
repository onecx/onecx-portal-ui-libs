...
describe('Topic', () => {
  ...
  beforeEach(() => {
    ...
    g['@onecx/accelerator'].topic.debug = ['SpecificTestTopic']
  ...
  afterEach(() => {
    ...
    BroadcastChannelMock.asyncCalls = false
    if (acceleratorState['@onecx/accelerator'].topic.debug) {
      acceleratorState['@onecx/accelerator'].topic.debug = undefined
    }
  })
  ...
  it('logs window message when debug enabled and handles TopicGet on window path', () => {
    acceleratorState['@onecx/accelerator'].topic.debug = ['win-topic']
    acceleratorState['@onecx/accelerator'].topic.useBroadcastChannel = false
