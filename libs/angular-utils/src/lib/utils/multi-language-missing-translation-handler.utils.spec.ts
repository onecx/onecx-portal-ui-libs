...
import { MissingTranslationHandlerParams, TranslateFakeLoader, getValue } from '@ngx-translate/core'
...
describe('MultiLanguageMissingTranslationHandler', () => {
  ...
  it('should use ngx-translate getValue and parser from translateService', (done) => {
    userServiceMock.profile$.publish({
      settings: {
        locales: ['en'],
      },
