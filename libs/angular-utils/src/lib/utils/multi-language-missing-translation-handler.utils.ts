...
import { MissingTranslationHandler, getValue, MissingTranslationHandlerParams, TranslateNoOpLoader, TranslateParser } from '@ngx-translate/core'
  ...
  private requireTranslation(
    ...
    const translatedValue =
      interpolateValue === undefined
        ? undefined
        : this.parser.interpolate(interpolateValue, params.interpolateParams)
