    ...
    declarations: [
      {
        ...
        from: 'primitives.area.overlay.defaultState.defaultSeverity.bg.color',
      },
      {
        property: 'background-image',
        from: 'primitives.area.overlay.defaultState.defaultSeverity.bg.image',
      },
      {
        property: 'background-position',
        from: 'primitives.area.overlay.defaultState.defaultSeverity.bg.position',
      },
      {
        property: 'background-size',
        from: 'primitives.area.overlay.defaultState.defaultSeverity.bg.size',
      },
      {
        property: 'background-repeat',
        from: 'primitives.area.overlay.defaultState.defaultSeverity.bg.repeat',
      },
    ],
  },
  {
