...
export const pageHeaderCssRules: CssRule[] = [
  {
    ...
    declarations: [
      ...
      { property: 'box-shadow', from: 'usages.pageHeader.border.shadow' },
      { property: 'padding-left', from: 'usages.pageHeader.paddingX' },
      { property: 'padding-right', from: 'usages.pageHeader.paddingX' },
      { property: 'padding-top', from: 'usages.pageHeader.paddingY' },
      { property: 'padding-bottom', from: 'usages.pageHeader.paddingY' },
      { property: 'margin-left', from: 'usages.pageHeader.marginX' },
      { property: 'margin-right', from: 'usages.pageHeader.marginX' },
      { property: 'margin-top', from: 'usages.pageHeader.marginY' },
      { property: 'margin-bottom', from: 'usages.pageHeader.marginY' },
    ],
  },
  {
