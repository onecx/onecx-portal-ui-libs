...
// Simple component to test the directive with full page overlay
@Component({
...
// Component to test the directive with element overlay
@Component({
...
// Component to test the directive with small loader
@Component({
...
// Component to test the directive without overlay (default)
@Component({
