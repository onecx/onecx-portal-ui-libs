...
export const multiselectStyles = multiselectBaseStyles
  .extend({
    ...
    overlay: z
      .object({
        background: z.union([bg, withRef(z.string())]).optional().default("{{primitives.area.overlay.defaultState.defaultVariant.bg}}"),
    ...
    option: z
      .object({
        focusBackground: z.union([bg, withRef(z.string())]).optional().default("{{primitives.defaultVariant.state.hover.defaultVariant.bg}}"),
        selectedBackground: z.union([bg, withRef(z.string())]).optional().default("{{primitives.variant.primary.defaultState.defaultVariant.bg}}"),
        selectedFocusBackground: z.union([bg, withRef(z.string())]).optional().default("{{primitives.variant.primary.state.focus.defaultVariant.bg}}"),
        color: color.optional().default("{{primitives.defaultVariant.defaultState.defaultVariant.contrast}}"),
        ...
        selectedFocusColor: color.optional().default("{{primitives.variant.primary.state.focus.defaultVariant.contrast}}"),
    ...
    optionGroup: z
      .object({
        background: z.union([bg, withRef(z.string())]).optional().default("transparent"),
        color: color.optional().default("{{primitives.defaultVariant.defaultState.defaultVariant.contrast}}"),
...
export const multiselect = z
  .object({
    ...
    defaultVariant: (multiselectWithStates as typeof multiselectWithStates).optional(),
    variant: z
      .object({
        filledVariant: (filledMultiselectStateWithStates as typeof filledMultiselectStateWithStates).optional(),
      })
      .optional(),
  })
