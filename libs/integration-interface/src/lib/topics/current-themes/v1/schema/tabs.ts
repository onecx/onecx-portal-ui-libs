...
import { bg, color, borderWithShadow, font, withRef } from './primitives'
  ...
  .object({
        ...
        state: z
          .object({
            ...
            active: tabsTabState.default({
              ...
              color: '{{primitives.variant.primary.defaultState.defaultVariant.bg.color}}',
            }),
    ...
    activeBar: z
      .object({
        ...
        transition: withRef(z.string()).default('250ms cubic-bezier(0.35, 0, 0.25, 1)'),
        background: z
          .union([bg, withRef(z.string())])
