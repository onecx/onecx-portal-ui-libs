...
import { SearchHeaderSchema } from './search-header'

describe('search header schema - should inherit following tokens from page-header -', () => {
  it('empty tokens', () => {
    const result = SearchHeaderSchema.schema.safeParse({})
  ...
  it('Base tokens', () => {
    ...
    expectExactUndefinedTokens(value, SearchHeaderSchema.schema.shape, [])
