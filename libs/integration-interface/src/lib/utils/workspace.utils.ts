 ...
 */
const constructBaseUrlFromWorkspace = (workspace: Workspace, warn: WarnHandler): string => {
 ...
 */
const fillParamsForPath = (path: string, endpointParameters: EndpointParameters, warn: WarnHandler): string => {
...
const constructEndpointUrl = (
  route: Route,
  endpointName: string,
  endpointParameters: EndpointParameters | undefined,
