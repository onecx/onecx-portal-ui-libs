...
import { SvcContainer } from '../containers/abstract/onecx-svc'
import { BffContainer } from '../containers/abstract/onecx-bff'
import { UiContainer } from '../containers/abstract/onecx-ui'
...
export class ContainerFactory {
   ...
   */
  async createAndStartContainers(config: PlatformConfig): Promise<Map<string, AllowedContainerTypes>> {
