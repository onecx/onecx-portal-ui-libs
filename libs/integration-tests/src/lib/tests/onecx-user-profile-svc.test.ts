...
import { OnecxWorkspaceSvcContainer, StartedOnecxWorkspaceSvcContainer } from '../containers/svc/onecx-workspace-svc'
import axios from 'axios'

describe('Default workspace-svc Testcontainer', () => {
  let pgContainer: StartedOnecxPostgresContainer
  let kcContainer: StartedOnecxKeycloakContainer
  let userProfileSvcContainer: StartedOnecxWorkspaceSvcContainer
  ...
  beforeAll(async () => {
    ...
    userProfileSvcContainer = await new OnecxWorkspaceSvcContainer(
